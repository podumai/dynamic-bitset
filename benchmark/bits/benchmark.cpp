...
BITS_CopyAssignmentBenchmark(BITS_DB(unsigned char), operator=(const DynamicBitset&));
BITS_CopyAssignmentBenchmark(BITS_DB(unsigned short), operator=(const DynamicBitset&));
BITS_CopyAssignmentBenchmark(BITS_DB(unsigned), operator=(const DynamicBitset&));
BITS_CopyAssignmentBenchmark(BITS_DB(unsigned long), operator=(const DynamicBitset&));
BITS_CopyAssignmentBenchmark(BITS_DB(unsigned long long), operator=(const DynamicBitset&));

BITS_MoveAssignmentBenchmark(BITS_DB(unsigned char), operator=(DynamicBitset&&));
BITS_MoveAssignmentBenchmark(BITS_DB(unsigned short), operator=(DynamicBitset&&));
BITS_MoveAssignmentBenchmark(BITS_DB(unsigned), operator=(DynamicBitset&&));
BITS_MoveAssignmentBenchmark(BITS_DB(unsigned long), operator=(DynamicBitset&&));
BITS_MoveAssignmentBenchmark(BITS_DB(unsigned long long), operator=(DynamicBitset&&));
