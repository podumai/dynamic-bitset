...
#define STD_DB std::vector<bool>
#define STD_CONST_DB const std::vector<bool>

BITS_DefaultConstructorBenchmark(STD_DB, std::vector());

BITS_CopyConstructorBenchmark(STD_DB, std::vector(const std::vector&));

BITS_MoveConstructorBenchmark(STD_DB, std::vector(std::vector&&));

BITS_CopyAssignmentBenchmark(STD_DB, operator=(const vector&));

BITS_MoveAssignmentBenchmark(STD_DB, operator=(vector&&));
